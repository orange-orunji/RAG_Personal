...
[第一轮] 首次请求（写入缓存）...
  1. python为什么是大冒险流行语言？   状态:200 长度:967 耗时:15.96s
  2. Java 工程化人设是什么？       状态:200 长度:1163 耗时:19.81s
  3. Redis 分布式锁怎么用？       状态:200 长度:1850 耗时:30.57s
  4. HyDE 是什么？            状态:200 长度:1382 耗时:20.33s
  5. 如何优化 SQL 查询？         状态:200 长度:2072 耗时:24.86s
  6. 怎么进行docker部署         状态:200 长度:2096 耗时:33.25s
  7. Rerank是什么            状态:200 长度:1408 耗时:21.42s
  8. 为什么redis需要看门狗        状态:200 长度:1169 耗时:22.10s
  9. docker前置知识要学Linux吗   状态:200 长度:1348 耗时:24.53s
  10. github是什么            状态:200 长度:1487 耗时:18.33s

[第二轮] 相同问题再次请求（应该命中缓存）...
  1. python为什么是大冒险流行语言？   状态:200 长度:71 耗时:0.01s
  2. Java 工程化人设是什么？       状态:200 长度:17 耗时:0.01s
  3. Redis 分布式锁怎么用？       状态:200 长度:85 耗时:0.01s
  4. HyDE 是什么？            状态:200 长度:130 耗时:0.01s
  5. 如何优化 SQL 查询？         状态:200 长度:87 耗时:0.01s
  6. 怎么进行docker部署         状态:200 长度:126 耗时:0.01s
  7. Rerank是什么            状态:200 长度:92 耗时:0.01s
  8. 为什么redis需要看门狗        状态:200 长度:56 耗时:0.01s
